...
#SBATCH -J infer-quantum
#SBATCH -t 480
#SBATCH -c 16
#SBATCH -G 1
#SBATCH --mem=64G
#SBATCH -o run/logs/infer_quantum_%j.out
#SBATCH -e run/logs/infer_quantum_%j.err
...
if [[ -z "$CKPT" ]]; then
    ...
    echo "       Run 05_train_quantum.sh first, or pass the path manually."
    exit 1
fi
